...
h1 { font-size: 2em; font-weight: 700; margin: 0 0 .4em; line-height: 1.2; }
h2 { font-size: 1.45em; font-weight: 700; margin: 1.5em 0 .4em; padding-bottom: .25em; border-bottom: 1px solid #e0e0e0; }
h3 { font-size: 1.2em; font-weight: 700; margin: 1.3em 0 .3em; }
h4, h5, h6 { font-size: 1em; font-weight: 700; margin: 1.1em 0 .25em; }
...
blockquote {
  ...
  border-left: 4px solid #d0d0d0; color: #555555; background: #f9f9f9; font-style: italic;
}
...
code {
  ...
  font-size: .855em; background: #f0f0f0; padding: 2px 5px; border-radius: 3px; color: #c0392b;
}
pre {
  background: #f6f8fa; border: 1px solid #e0e0e0; border-radius: 5px;
  padding: 1em 1.2em; overflow-x: auto; margin: 0 0 1em; font-size: .855em; line-height: 1.55;
}
...
table {
  ...
  font-size: .9em; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif;
  background: #ffffff; color: #111111;
}
thead tr { background: #f2f4f6; }
th {
  background: #f2f4f6; color: #111111; font-weight: 600; text-align: left;
  padding: 8px 12px; border: 1px solid #b0b8c1;
}
td { padding: 7px 12px; border: 1px solid #b0b8c1; color: #111111; background: #ffffff; }
tbody tr:nth-child(even) td { background: #f8f9fa; }
.wikilink { color: #0078d4; background: rgba(0,120,212,.07); border-radius: 3px; padding: 1px 4px; }
...
.view-label {
  ...
  letter-spacing: .05em; color: #555; margin-bottom: .45em;
}
.view-empty { font-style: italic; color: #888; font-size: .9em; }
.view-error { font-style: italic; color: #b91c1c; font-size: .9em; }
.view-table {
  width: 100%; border-collapse: collapse; margin: 0;
  font-size: .88em; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif;
}
.view-table th {
  background: #f2f4f6; color: #111; font-weight: 600; text-align: left;
  padding: 6px 10px; border: 1px solid #c8cdd2;
}
.view-table td { padding: 5px 10px; border: 1px solid #c8cdd2; color: #111; background: #fff; }
