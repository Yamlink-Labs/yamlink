...
<div class="shell">
  <div class="toolbar">
    ...
    <button class="layer-btn" id="hoverFocusBtn" type="button" aria-pressed="false" title="When on, hovering or dragging a node dims everything not connected to it. Off by default so you can drag nodes around freely without the rest of the graph going dark.">Focus</button>
