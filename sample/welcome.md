...
You stop at any level. Use only notes and links and you get Note Report, Graph, and rename-safe references. Add `!view` queries and you get a live database. Add schemas and you get validation. The system rewards investment but never requires it.
...
Open any note. **Note Report** in the Yamlink sidebar shows the note's structured links, body mentions, tasks, and the next view that makes the most sense from that note.
...
Open `dashboard.md` and click **▶ Run views** to see live queries. Open `johnny-rico.md` and run `Yamlink: Open Note Report`. Browse any character file — Note Report and Graph show how the note fits into the vault.
...
| `dizzy-flores.md` | Contact-style note, Note Report and graph connections |
